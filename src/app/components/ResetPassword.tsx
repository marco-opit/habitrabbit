...
export function ResetPassword({ onPasswordUpdated }: { onPasswordUpdated: () => void }) {
    ...
    const handleUpdatePassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setMessage({ type: 'error', text: error.message || 'An error occurred while updating the password.' })
        } finally {
            setLoading(false)
        }
    }
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-6">
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <CheckCircle2 className="w-6 h-6" /> Updated!
                                </>
                            ) : (
                                <>
